...
const ServiceCard = ({ service }) => {
   return (
      <li>
         <div className="bg-white p-10 space-y-4 flex flex-col min-h-min h-full shadow rounded-xl">
            ...
            <div className="flex-grow flex items-end justify-center py-2">
               <Link className="py-1.5 px-4 relative group overflow-hidden font-medium  inline-block custom-next border-ourDeeperGold border hover:border-black bg-ourCoffee text-ourLighterYellow uppercase rounded-md">
